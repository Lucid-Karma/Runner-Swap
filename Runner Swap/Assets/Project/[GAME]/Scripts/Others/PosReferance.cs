...
public class PosReferance : MonoBehaviour
{
    ...
    public void Pos()
    {
        mainPosition = transform.position;
            ...
            {
                mainPosition = Vector3.down + Vector3.left * 100; //new Vector3(-26, 0, 0);
                coinPosition = Vector3.down + Vector3.left * 3;
            }
            else if(SwipeController.isItLeft)
            {
                mainPosition = Vector3.down + Vector3.right * 100; //new Vector3(26, 0, 0);
                coinPosition = Vector3.down + Vector3.right * 3;
            }
